...
async function loadSettings() {
  const { githubUsername, githubPAT, groupColor, excludedRepos, excludeDependabot } =
    await chrome.storage.sync.get([
      'githubUsername', 'githubPAT', 'groupColor', 'excludedRepos', 'excludeDependabot',
    ]);
...
btnClearDismissed.addEventListener('click', async () => {
  ...
  await loadDismissedCount();
  showStatus('Liste des PRs ignorées réinitialisée. Elles réapparaîtront à la prochaine sync.', 'success');
